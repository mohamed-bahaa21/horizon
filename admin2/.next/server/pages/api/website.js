...
module.exports = __webpack_require__("cmop");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    if (website_id) {
      const website = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getWebsiteById */ "q"])(website_id);
      ...
      if (enable_share_url) {
        share_id = share_id ? share_id : Object(lib_crypto__WEBPACK_IMPORTED_MODULE_2__[/* getRandomChars */ "d"])(8);
      } else {
        share_id = null;
      }

      await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* updateWebsite */ "y"])(website_id, {
        name,
        domain,
        share_id
      });
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_3__[/* ok */ "d"])(res);
    } else {
      const website_uuid = Object(lib_crypto__WEBPACK_IMPORTED_MODULE_2__[/* uuid */ "i"])();
      const share_id = enable_share_url ? Object(lib_crypto__WEBPACK_IMPORTED_MODULE_2__[/* getRandomChars */ "d"])(8) : null;
      const website = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* createWebsite */ "c"])(user_id, {
        website_uuid,
        name,
        domain,
        share_id
      });
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_3__[/* ok */ "d"])(res, website);
    }
  }
