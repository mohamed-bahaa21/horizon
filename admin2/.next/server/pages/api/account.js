...
module.exports = __webpack_require__("bYCT");
...
/* harmony import */ var lib_middleware__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("FeB/");
/* harmony import */ var lib_crypto__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("xDR2");
/* harmony import */ var lib_response__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("ghg3");




/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  await Object(lib_middleware__WEBPACK_IMPORTED_MODULE_1__[/* useAuth */ "a"])(req, res);
  const {
  ...
  if (req.method === 'POST') {
    ...
    if (user_id) {
      const account = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getAccountById */ "f"])(user_id);

      if (account.user_id === current_user_id || current_user_is_admin) {
        const data = {};

        if (password) {
          data.password = Object(lib_crypto__WEBPACK_IMPORTED_MODULE_2__[/* hashPassword */ "e"])(password);
        ...
        if (data.username && account.username !== data.username) {
          const accountByUsername = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getAccountByUsername */ "g"])(username);

          if (accountByUsername) {
            return Object(lib_response__WEBPACK_IMPORTED_MODULE_3__[/* badRequest */ "a"])(res, 'Account already exists');
          }
        }

        const updated = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* updateAccount */ "x"])(user_id, data);
        return Object(lib_response__WEBPACK_IMPORTED_MODULE_3__[/* ok */ "d"])(res, updated);
      }

      return Object(lib_response__WEBPACK_IMPORTED_MODULE_3__[/* unauthorized */ "f"])(res);
    } else {
      const accountByUsername = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getAccountByUsername */ "g"])(username);
      ...
      const created = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* createAccount */ "a"])({
        username,
        password: Object(lib_crypto__WEBPACK_IMPORTED_MODULE_2__[/* hashPassword */ "e"])(password)
      });
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_3__[/* ok */ "d"])(res, created);
    }
  }

  return Object(lib_response__WEBPACK_IMPORTED_MODULE_3__[/* methodNotAllowed */ "b"])(res);
});
