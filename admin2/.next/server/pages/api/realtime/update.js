...
module.exports = __webpack_require__("jfnx");
...
/* harmony import */ var lib_middleware__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("FeB/");
...
/* harmony import */ var lib_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("YSmr");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  await Object(lib_middleware__WEBPACK_IMPORTED_MODULE_0__[/* useAuth */ "a"])(req, res);

  if (req.method === 'GET') {
    const {
      start_at
    } = req.query;
    const token = req.headers[lib_constants__WEBPACK_IMPORTED_MODULE_4__[/* TOKEN_HEADER */ "B"]];

    if (!token) {
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_1__[/* badRequest */ "a"])(res);
    }

    const {
      websites
    } = await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_3__[/* parseToken */ "h"])(token);
    const data = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_2__[/* getRealtimeData */ "m"])(websites, new Date(+start_at));
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_1__[/* ok */ "d"])(res, data);
  }
