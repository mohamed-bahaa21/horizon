...
module.exports = __webpack_require__("gBG5");
...
/* harmony import */ var lib_queries__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("R9qi");
/* harmony import */ var lib_crypto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("xDR2");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (req.method === 'GET') {
    ...
    const websites = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_3__[/* getUserWebsites */ "p"])(user_id);
    const ids = websites.map(({
      website_id
    }) => website_id);
    const token = await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_4__[/* createToken */ "c"])({
      websites: ids
    });
    const data = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_3__[/* getRealtimeData */ "m"])(ids, Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["subMinutes"])(new Date(), 30));
