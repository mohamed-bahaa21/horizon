...
module.exports = __webpack_require__("txVe");
...
/* harmony import */ var lib_crypto__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("xDR2");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (!is_admin && user_id !== auth_user_id) {
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_2__[/* unauthorized */ "f"])(res);
  }

  if (req.method === 'POST') {
    const account = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getAccountById */ "f"])(user_id);
    const valid = Object(lib_crypto__WEBPACK_IMPORTED_MODULE_3__[/* checkPassword */ "a"])(current_password, account.password);

    if (!valid) {
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_2__[/* badRequest */ "a"])(res, 'Current password is incorrect');
    }

    const password = Object(lib_crypto__WEBPACK_IMPORTED_MODULE_3__[/* hashPassword */ "e"])(new_password);
    const updated = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* updateAccount */ "x"])(user_id, {
      password
    });
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_2__[/* ok */ "d"])(res, updated);
  }

  return Object(lib_response__WEBPACK_IMPORTED_MODULE_2__[/* methodNotAllowed */ "b"])(res);
});
