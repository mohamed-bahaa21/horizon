...
module.exports = __webpack_require__("Nrn6");
...
/* harmony import */ var lib_crypto__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("xDR2");
...
/* harmony import */ var lib_response__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("ghg3");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (!username || !password) {
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_4__[/* badRequest */ "a"])(res);
  }

  const account = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_2__[/* getAccountByUsername */ "g"])(username);

  if (account && (await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_1__[/* checkPassword */ "a"])(password, account.password))) {
    const {
      user_id,
      username,
      is_admin
    } = account;
    const token = await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_1__[/* createSecureToken */ "b"])({
      user_id,
      username,
      is_admin
    });
    const cookie = Object(cookie__WEBPACK_IMPORTED_MODULE_0__["serialize"])(lib_constants__WEBPACK_IMPORTED_MODULE_3__[/* AUTH_COOKIE_NAME */ "a"], token, {
      path: '/',
      httpOnly: true,
      sameSite: true,
      maxAge: 60 * 60 * 24 * 365
    ...
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_4__[/* ok */ "d"])(res, {
      token
    });
  }

  return Object(lib_response__WEBPACK_IMPORTED_MODULE_4__[/* unauthorized */ "f"])(res);
});
