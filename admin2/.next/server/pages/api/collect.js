...
module.exports = __webpack_require__("FVZN");
...
/* harmony import */ var isbot__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("zlZz");
/* harmony import */ var isbot__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(isbot__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var ipaddr_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("zjHJ");
...
/* harmony import */ var lib_queries__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("R9qi");
/* harmony import */ var lib_middleware__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("FeB/");
/* harmony import */ var lib_request__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("sCDx");
/* harmony import */ var lib_response__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("ghg3");
/* harmony import */ var lib_crypto__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("xDR2");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  await Object(lib_middleware__WEBPACK_IMPORTED_MODULE_3__[/* useCors */ "b"])(req, res);

  if (isbot__WEBPACK_IMPORTED_MODULE_0___default()(req.headers['user-agent'])) {
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_5__[/* ok */ "d"])(res);
  }

  if (process.env.IGNORE_IP) {
    const ips = process.env.IGNORE_IP.split(',').map(n => n.trim());
    const ip = Object(lib_request__WEBPACK_IMPORTED_MODULE_4__[/* getIpAddress */ "b"])(req);
    const blocked = ips.find(i => {
      if (i === ip) return true; // CIDR notation

      if (i.indexOf('/') > 0) {
        const addr = ipaddr_js__WEBPACK_IMPORTED_MODULE_1___default.a.parse(ip);
        const range = ipaddr_js__WEBPACK_IMPORTED_MODULE_1___default.a.parseCIDR(i);
  ...
  await Object(lib_middleware__WEBPACK_IMPORTED_MODULE_3__[/* useSession */ "c"])(req, res);
  const {
    type,
    payload
  } = req.body;
  ...
  if (type === 'pageview') {
    ...
    await Object(lib_queries__WEBPACK_IMPORTED_MODULE_2__[/* savePageView */ "w"])(website_id, session_id, url, referrer);
  } else if (type === 'event') {
    const {
      url,
      event_type,
    ...
    await Object(lib_queries__WEBPACK_IMPORTED_MODULE_2__[/* saveEvent */ "v"])(website_id, session_id, url, event_type, event_value);
  } else {
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_5__[/* badRequest */ "a"])(res);
  }

  const token = await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_6__[/* createToken */ "c"])({
    website_id,
    session_id
  });
  return Object(lib_response__WEBPACK_IMPORTED_MODULE_5__[/* ok */ "d"])(res, token);
});
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "b", function() { return /* binding */ useCors; });
__webpack_require__.d(__webpack_exports__, "c", function() { return /* binding */ useSession; });
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ useAuth; });
...
// EXTERNAL MODULE: ./lib/queries.js + 1 modules
var queries = __webpack_require__("R9qi");

// EXTERNAL MODULE: ./lib/request.js
var request = __webpack_require__("sCDx");

// EXTERNAL MODULE: ./lib/crypto.js
var lib_crypto = __webpack_require__("xDR2");
...
async function getSession(req) {
  ...
  if (cache) {
    const result = await Object(lib_crypto["h" /* parseToken */])(cache);
  ...
  if (!Object(lib_crypto["f" /* isValidUuid */])(website_uuid)) {
  ...
  const {
    ...
    country,
    device
  } = await Object(request["a" /* getClientInfo */])(req, payload);
  const website = await Object(queries["s" /* getWebsiteByUuid */])(website_uuid);
  ...
  const session_uuid = Object(lib_crypto["i" /* uuid */])(website_id, hostname, ip, userAgent, os);
  let session = await Object(queries["n" /* getSessionByUuid */])(session_uuid);

  if (!session) {
    session = await Object(queries["b" /* createSession */])(website_id, {
      session_uuid,
      hostname,
      browser,
      os,
...
// EXTERNAL MODULE: ./lib/response.js
var response = __webpack_require__("ghg3");

// CONCATENATED MODULE: ./lib/middleware.js
...
const useCors = use(external_cors_default()());
const useSession = use(async (req, res, next) => {
  let session;
  ...
  try {
    ...
    console.error(e);
    return Object(response["e" /* serverError */])(res, e.message);
  }

  if (!session) {
    return Object(response["a" /* badRequest */])(res);
  }

  req.session = session;
  next();
});
const useAuth = use(async (req, res, next) => {
  const token = await Object(auth["b" /* getAuthToken */])(req);

  if (!token) {
    return Object(response["f" /* unauthorized */])(res);
  }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getIpAddress; });
/* unused harmony export getDevice */
/* unused harmony export getCountry */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getClientInfo; });
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("oyvS");
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var request_ip__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("2bsM");
...
/* harmony import */ var detect_browser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("1qEK");
...
/* harmony import */ var is_localhost_ip__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("imoi");
...
/* harmony import */ var maxmind__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("oHtO");
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("YSmr");
...
function getIpAddress(req) {
  ...
  return request_ip__WEBPACK_IMPORTED_MODULE_1___default.a.getClientIp(req);
}
function getDevice(screen, browser, os) {
  if (!screen) return;
  const [width] = screen.split('x');

  if (_constants__WEBPACK_IMPORTED_MODULE_5__[/* DESKTOP_OS */ "i"].includes(os)) {
    if (os === 'Chrome OS' || width < _constants__WEBPACK_IMPORTED_MODULE_5__[/* DESKTOP_SCREEN_WIDTH */ "j"]) {
      return 'laptop';
    }

    return 'desktop';
  } else if (_constants__WEBPACK_IMPORTED_MODULE_5__[/* MOBILE_OS */ "q"].includes(os)) {
    if (os === 'Amazon OS' || width > _constants__WEBPACK_IMPORTED_MODULE_5__[/* MOBILE_SCREEN_WIDTH */ "r"]) {
      return 'tablet';
    }
  ...
  if (width >= _constants__WEBPACK_IMPORTED_MODULE_5__[/* DESKTOP_SCREEN_WIDTH */ "j"]) {
    return 'desktop';
  } else if (width >= _constants__WEBPACK_IMPORTED_MODULE_5__[/* LAPTOP_SCREEN_WIDTH */ "n"]) {
    return 'laptop';
  } else if (width >= _constants__WEBPACK_IMPORTED_MODULE_5__[/* MOBILE_SCREEN_WIDTH */ "r"]) {
    return 'tablet';
  } else {
    return 'mobile';
  }
...
async function getCountry(req, ip) {
  ...
  if (!lookup) {
    lookup = await maxmind__WEBPACK_IMPORTED_MODULE_4___default.a.open(path__WEBPACK_IMPORTED_MODULE_0___default.a.resolve('./public/geo/GeoLite2-Country.mmdb'));
  }
...
async function getClientInfo(req, {
  ...
  const browser = Object(detect_browser__WEBPACK_IMPORTED_MODULE_2__["browserName"])(userAgent);
  const os = Object(detect_browser__WEBPACK_IMPORTED_MODULE_2__["detectOS"])(userAgent);
