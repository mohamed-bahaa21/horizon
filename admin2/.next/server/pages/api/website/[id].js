...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (req.method === 'GET') {
    ...
    const website = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getWebsiteById */ "q"])(websiteId);
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_1__[/* ok */ "d"])(res, website);
  }

  if (req.method === 'DELETE') {
    if (!(await Object(lib_auth__WEBPACK_IMPORTED_MODULE_2__[/* allowQuery */ "a"])(req, true))) {
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_1__[/* unauthorized */ "f"])(res);
    }

    await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* deleteWebsite */ "e"])(websiteId);
...
module.exports = __webpack_require__("/QRr");
