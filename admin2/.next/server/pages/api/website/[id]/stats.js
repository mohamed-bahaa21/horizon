...
module.exports = __webpack_require__("Exqk");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  if (req.method === 'GET') {
    ...
    const metrics = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getWebsiteStats */ "t"])(websiteId, startDate, endDate, {
      url
    });
    const prevPeriod = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getWebsiteStats */ "t"])(websiteId, prevStartDate, prevEndDate, {
      url
    });
    ...
    return Object(lib_response__WEBPACK_IMPORTED_MODULE_1__[/* ok */ "d"])(res, stats);
  }
