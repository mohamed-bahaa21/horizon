...
module.exports = __webpack_require__("RKDr");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  if (req.method === 'GET') {
    ...
    if (sessionColumns.includes(type)) {
      const data = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getSessionMetrics */ "o"])(websiteId, startDate, endDate, type, {
        url
      });
    ...
    if (pageviewColumns.includes(type) || type === 'event') {
      ...
      if (type === 'referrer') {
        const website = Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getWebsiteById */ "q"])(websiteId);
      ...
      const data = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getPageviewMetrics */ "k"])(websiteId, startDate, endDate, getColumn(type), getTable(type), {
        domain,
        url: type !== 'url' && url
      });
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_1__[/* ok */ "d"])(res, data);
