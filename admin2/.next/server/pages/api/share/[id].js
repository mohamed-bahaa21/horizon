...
module.exports = __webpack_require__("Pvbs");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (req.method === 'GET') {
    const website = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* getWebsiteByShareId */ "r"])(id);

    if (website) {
      const websiteId = website.website_id;
      const token = await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_2__[/* createToken */ "c"])({
        website_id: websiteId
      });
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_1__[/* ok */ "d"])(res, {
        websiteId,
        token
      });
    }

    return Object(lib_response__WEBPACK_IMPORTED_MODULE_1__[/* notFound */ "c"])(res);
  }
